...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController2 : MonoBehaviour
    {
        ...
        public string _leftjoyx = "LeftJoyX2";
        public string _leftjoyy = "LeftJoyY2";
        ...
        private void Update()
        {
            ...
            if (!m_Jump)
            {
                m_Jump = CrossPlatformInputManager.GetButtonDown("North2");
            }
        ...
        {
            // Read input
            float horizontal = CrossPlatformInputManager.GetAxis(_leftjoyx);
            float vertical = CrossPlatformInputManager.GetAxis(_leftjoyy);
